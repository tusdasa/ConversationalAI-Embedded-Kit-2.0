 ...
 */
esp_err_t local_recorder_pipeline_run(recorder_pipeline_handle_t recorder_pipeline);
 ...
 *      - ESP_FAIL if the operation fails
 */
esp_err_t local_recorder_pipeline_stop(recorder_pipeline_handle_t recorder_pipeline);
 ...
 *      - ESP_FAIL if the operation fails
 */
esp_err_t local_recorder_pipeline_close(recorder_pipeline_handle_t recorder_pipeline);
 ...
 *       - <= 0                Error code
 */
int local_recorder_pipeline_get_default_read_size(recorder_pipeline_handle_t recorder_pipeline);
 ...
 *       - <= 0                Error code
 */
int local_recorder_pipeline_read(recorder_pipeline_handle_t recorder_pipeline, char *buffer, int buf_size);
