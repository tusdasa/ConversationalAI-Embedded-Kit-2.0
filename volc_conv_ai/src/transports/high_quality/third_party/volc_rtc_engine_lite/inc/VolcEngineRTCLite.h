...
#define BYTE_RTC_API_VERSION "1.1.0"
#define BYTE_RTC_API_VERSION_NUM 0x1100
 ...
 * @param extra_info extra_info数据 
 * @param extra_info_size extra_info长度，单位字节
 */
void (*on_audio_data)(byte_rtc_engine_t engine, const char* room, const char* uid, uint16_t sent_ts,
    audio_data_type_e codec, const void * data_ptr, size_t data_len,const uint8_t* extra_info, size_t extra_info_size);
